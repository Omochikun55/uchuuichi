...
def main():
    """有機化学PDF処理"""
    pdf_path = Path("/home/mochi/uchuichi-app/PDF/宇宙一わかりやすい化学（有機）/【有機・化学】宇宙一わかりやすい化学.pdf")
    output_dir = Path("/home/mochi/uchuichi-app/pdf-extractor/output_yuki")
